function [ x, f, PersistentState ] = ACDResumeWrapper( OptiFunction, x, lb, ub, PersistentState, varargin )
    ...
    [ x, f, PersistentState ] = ACDMinimisation( ...
        ...
        x, sigma, eps, lb, ub, [], [], Inf, -Inf, 1, Order, 1, ProductSearchDimension, PersistentState, true );
